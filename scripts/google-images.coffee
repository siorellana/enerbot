...
#
# Commands:
#   hubot meme <query> - The Original. Queries Google Images for <query> and returns a random top result.
#   hubot gif <query> - The same thing as `image me`, except adds a few parameters to try to return an animated GIF instead.
